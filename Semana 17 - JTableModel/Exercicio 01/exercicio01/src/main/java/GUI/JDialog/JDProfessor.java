...
public class JDProfessor extends javax.swing.JDialog {
    ...
    public JDProfessor(java.awt.Frame parent, boolean modal, GerenteProfessor gerente, TMProfessor tMProfessor) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanelTitleLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTitleLayout.createSequentialGroup()
                .addGap(315, 315, 315)
                .addComponent(jlbTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 343, Short.MAX_VALUE)
                .addGap(256, 256, 256))
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        P1 = this.professores.Busca(CPF_Professor);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        Professor localizacao_list = this.professores.Busca(CPF);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (edicao == false){
           ...
           Professor P1 = professores.Busca(Teste.getCpf());
           AtualizarTabela();
           if (P1 == null){
                professores.Adiciona(Teste);
                this.Limpar_Campos();
                this.Habilitar_Campos(false);
            }else{
            ...
            this.Coletar_Campos(Teste);
            this.professores.Editar(professor.getCpf(), Teste);
            AtualizarTabela();
